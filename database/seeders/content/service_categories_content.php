...
return [
    ...
    'tally-solutions' => [
        'description' => 'TallyPrime sales and licensing, TSS renewal, Tally on Cloud, customization, TallyPrime Server, support and data migration for businesses across Dubai and the UAE.',
        'capabilities' => [
            'TallyPrime Silver and Gold licence sales and upgrades',
            'TSS (Tally Software Services) renewal and reactivation',
            'Custom TDL add-ons, reports and print formats',
            'Tally on Cloud hosting and remote access setup',
            'TallyPrime Server for high-concurrency, multi-user environments',
        ...
        'benefits' => [
            'Work with a local, responsive Tally team in Dubai instead of a call center',
        ...
        'faq' => [
            ['q' => 'Which TallyPrime edition do I need?', 'a' => 'Silver is single-user; Gold supports multiple users; TallyPrime Server adds a data-server architecture on Gold for high-concurrency teams. Tell us how many people use Tally and we will recommend one.'],
