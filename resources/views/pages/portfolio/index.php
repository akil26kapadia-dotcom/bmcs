...
<section class="relative bg-navy-950 overflow-hidden">
    ...
    <div class="relative container-custom py-16 md:py-20 text-center">
        ...
        <p class="mt-3 text-xs text-white/40 uppercase tracking-wide">
...
<section class="relative bg-navy-950 overflow-hidden">
    ...
    <div class="relative container-custom py-16 text-center">
        ...
        <p class="mt-3 text-white/70 max-w-xl mx-auto">Tell us what you're trying to achieve and we'll help you plan it.</p>
        <div class="mt-6">
